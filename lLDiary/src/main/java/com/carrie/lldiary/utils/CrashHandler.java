...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private String saveCrashInfo2File(Throwable ex) {
		...
		sp.edit().putString(DateUtil.getCurrent_Date_Time_Week(),result).apply();

		AlertDialogUtils.showCancelDialog(mContext,DateUtil.getCurrent_Date_Time_Week(),result);

		try {
			String time = formatter.format(new Date());
			String packageName = mContext.getPackageName();
			String fileName = packageName + time + ".log";
