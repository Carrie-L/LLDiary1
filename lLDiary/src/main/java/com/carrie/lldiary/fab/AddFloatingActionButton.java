package com.carrie.lldiary.fab;
  ...
  Drawable getIconDrawable() {
    ...
    final Shape shape = new Shape() {
      ...
      public void draw(Canvas canvas, Paint paint) {
        //外部圆圈 与 左边的位移，与 上、右、下 的距离
        canvas.drawRect(plusOffset, iconHalfSize - plusHalfStroke, iconSize - plusOffset, iconHalfSize + plusHalfStroke, paint);//加号横线
        //中间小图标 与 左边的位移，与 上、右、下 的距离
        canvas.drawRect(iconHalfSize - plusHalfStroke, plusOffset, iconHalfSize + plusHalfStroke, iconSize - plusOffset, paint);//加号竖线
      }
    };
