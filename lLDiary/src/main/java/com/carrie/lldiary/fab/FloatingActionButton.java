...
//  private int getDrawableId(int mSize){
//    if(mSize == SIZE_NORMAL){
//      return R.drawable.fab_bg_normal;
//    }else  if(mSize == SIZE_MINI){
//      return R.drawable.fab_bg_mini;
//    }else{
//      return R.drawable.fab_bg_large;
//    }
//  }
  ...
  private Drawable createCircleDrawable(int color, float strokeWidth) {
    ...
    paint.setColor(opaqueColor);//设置不透明颜色
